        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-16 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-[40%_60%] gap-8 lg:gap-12 items-center">
            ...
            <div className="text-white space-y-6 blur-to-focus">
              <p className="text-xs uppercase tracking-[0.3em] text-gold font-light">PROFESSOR • SURGEON • INNOVATOR</p>
              <h1
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg mb-6 opacity-90">
            Schedule a consultation with Professor Dr. Karaaltin to discuss your goals and learn how we can help you
            achieve them.
          </p>
          <Link to="/contact">
            <Button
