  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
        <img
          src="/placeholder.svg"
          alt="Twirl Internal Bra Technique Hero"
      ...
      <section className="section-spacing bg-white">
        <div className="container mx-auto px-8">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { step: "01", title: "Consultation", description: "Comprehensive breast assessment" },
              { step: "02", title: "Pedicle Planning", description: "Anatomical mapping for optimal vectors" },
              { step: "03", title: "Tissue Rotation", description: "Twirl Maneuver execution" },
              { step: "04", title: "Internal Support", description: "Fibrosis creation" },
              { step: "05", title: "Final Shaping", description: "Contour refinement" }
            ].map((item, index) => (
              <div 
                key={index} 
      ...
      <section className="candidates-section-dark">
        <div className="container mx-auto px-8">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { emoji: "⬆️", title: "Lift or Reduction", description: "Breast lift or reduction patients" },
              { emoji: "🚫", title: "Avoiding Implants", description: "Those seeking natural solutions" },
              { emoji: "📐", title: "Projection Concerns", description: "Addressing sagging or loss of volume" },
              { emoji: "⏳", title: "Long-Lasting Results", description: "Wanting stable upper pole fullness" }
            ].map((candidate, index) => (
              <div 
                key={index} 
