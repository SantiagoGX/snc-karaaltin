...
const SmartBRA = () => {
  ...
  const overviewCards = [
    { number: "01", titleKey: "procedurePages.smartbra.overview1Title", descKey: "procedurePages.smartbra.overview1Desc" },
    { number: "02", titleKey: "procedurePages.smartbra.overview2Title", descKey: "procedurePages.smartbra.overview2Desc" },
    { number: "03", titleKey: "procedurePages.smartbra.overview3Title", descKey: "procedurePages.smartbra.overview3Desc" },
    { number: "04", titleKey: "procedurePages.smartbra.overview4Title", descKey: "procedurePages.smartbra.overview4Desc" },
    { number: "05", titleKey: "procedurePages.smartbra.overview5Title", descKey: "procedurePages.smartbra.overview5Desc" },
  ];

  const journeySteps = [
    { step: "01", titleKey: "procedurePages.common.consultation", descKey: "procedurePages.smartbra.journey1Desc" },
    { step: "02", titleKey: "procedurePages.smartbra.journey2Title", descKey: "procedurePages.smartbra.journey2Desc" },
    { step: "03", titleKey: "procedurePages.smartbra.journey3Title", descKey: "procedurePages.smartbra.journey3Desc" },
    { step: "04", titleKey: "procedurePages.smartbra.journey4Title", descKey: "procedurePages.smartbra.journey4Desc" },
    { step: "05", titleKey: "procedurePages.smartbra.journey5Title", descKey: "procedurePages.smartbra.journey5Desc" },
  ];

  const candidates = [
    { emoji: "📏", titleKey: "procedurePages.smartbra.candidate1Title", descKey: "procedurePages.smartbra.candidate1Desc" },
    { emoji: "🔄", titleKey: "procedurePages.smartbra.candidate2Title", descKey: "procedurePages.smartbra.candidate2Desc" },
    { emoji: "⬇️", titleKey: "procedurePages.smartbra.candidate3Title", descKey: "procedurePages.smartbra.candidate3Desc" },
    { emoji: "🌟", titleKey: "procedurePages.smartbra.candidate4Title", descKey: "procedurePages.smartbra.candidate4Desc" },
  ];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
          <img alt={t("procedurePages.smartbra.title")} className="absolute inset-0 w-full h-full object-cover animate-[scale-in_1.5s_ease-out]" src="/lovable-uploads/bb50ba5e-477b-4909-b9d2-32cd59312d0f.jpg" />
        ...
        <section className="section-spacing bg-white">
          <div className="container mx-auto px-8 max-w-4xl text-center content-spacing">
            <p className="text-base md:text-lg text-gray-700 leading-relaxed animate-fade-in">
              {t("procedurePages.smartbra.intro")}
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-8">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-12 lg:gap-16 relative">
              <div className="overview-sticky-left animate-fade-in">
                <div>
                  <h2 className="overview-title-dark">Smart BRA</h2>
        ...
        <section className="section-spacing bg-white">
          <div className="container mx-auto px-8 max-w-4xl text-center content-spacing">
            <p className="text-base md:text-lg text-gray-700 leading-relaxed animate-fade-in">
              {t("procedurePages.smartbra.featured")}
            </p>
          </div>
        </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div className="order-2 lg:order-1 content-spacing animate-fade-in">
                  <h3 className="text-2xl md:text-3xl font-light tracking-wide uppercase mb-6">
                    {t("procedurePages.smartbra.techTitle")}
                  </h3>
                  <ul className="space-y-4 text-base md:text-lg text-gray-700">
                    <li className="flex items-start gap-3">
                      <span className="text-gray-900 font-bold mt-1">•</span>
                      <span>{t("procedurePages.smartbra.tech1")}</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-900 font-bold mt-1">•</span>
                      <span>{t("procedurePages.smartbra.tech2")}</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-900 font-bold mt-1">•</span>
                      <span>{t("procedurePages.smartbra.tech3")}</span>
                    </li>
                  </ul>
                </div>
                <div className="order-1 lg:order-2 animate-fade-in">
                  <img alt={t("procedurePages.smartbra.techTitle")} className="w-full aspect-[4/3] object-cover rounded-lg shadow-lg" src="/lovable-uploads/87330e94-0ce7-477e-9002-dd56fcdb1cb1.jpg" />
                </div>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div className="animate-fade-in">
                  <img alt={t("procedurePages.smartbra.outcomesTitle")} className="w-full aspect-[4/3] object-cover rounded-lg shadow-lg" src="/lovable-uploads/dbc15b10-b2b7-4ac9-bdfe-e17d2ab46101.png" />
                </div>
                <div className="content-spacing animate-fade-in">
                  <h3 className="text-2xl md:text-3xl font-light tracking-wide uppercase mb-6">
                    {t("procedurePages.smartbra.outcomesTitle")}
                  </h3>
                  <ul className="space-y-4 text-base md:text-lg text-gray-700">
                    <li className="flex items-start gap-3">
                      <span className="text-gray-900 font-bold mt-1">•</span>
                      <span>{t("procedurePages.smartbra.outcome1")}</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-900 font-bold mt-1">•</span>
                      <span>{t("procedurePages.smartbra.outcome2")}</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="section-spacing bg-gray-50">
          <div className="container mx-auto px-8">
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="animate-fade-in">
                <img alt={t("procedurePages.common.recoveryHealing")} className="w-full aspect-[4/3] object-cover rounded-lg shadow-lg" src="/lovable-uploads/90f78098-0037-48fc-a65a-f2ffab41f597.jpg" />
              </div>
              <div className="content-spacing animate-fade-in">
                ...
                <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-8">
                  {t("procedurePages.smartbra.recovery")}
                </p>
          ...
          <div className="container mx-auto px-8 text-center">
            <div className="max-w-3xl mx-auto content-spacing animate-fade-in">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-light tracking-wide uppercase mb-8">
                {t("procedurePages.smartbra.galleryCta")}
              </h2>
