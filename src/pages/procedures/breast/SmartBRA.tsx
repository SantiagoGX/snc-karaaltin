...
const SmartBRA = () => {
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
        <img alt="Smart BRA Bioscaffold Hero" className="absolute inset-0 w-full h-full object-cover animate-[scale-in_1.5s_ease-out]" src="/lovable-uploads/bb50ba5e-477b-4909-b9d2-32cd59312d0f.jpg" />
          ...
          <div className="max-w-6xl mx-auto space-y-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="order-1 lg:order-2 animate-fade-in">
                <img alt="Smart BRA Technology" className="w-full aspect-[4/3] object-cover rounded-lg shadow-lg" src="/lovable-uploads/87330e94-0ce7-477e-9002-dd56fcdb1cb1.jpg" />
              </div>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="animate-fade-in">
                <img alt="Long-Term Stability" className="w-full aspect-[4/3] object-cover rounded-lg shadow-lg" src="/lovable-uploads/dbc15b10-b2b7-4ac9-bdfe-e17d2ab46101.png" />
              </div>
        ...
        <div className="container mx-auto px-8">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[{
              ...
              step: "02",
              title: "Scaffold Selection",
              description: "Custom template design"
            }, {
              step: "03",
              title: "Surgical Placement",
              description: "Bioscaffold integration"
            }, {
              step: "04",
              title: "Integration Period",
              description: "Tissue incorporation"
            }, {
              step: "05",
              title: "Long-Term Stability",
              description: "Sustained lift support"
      ...
      <section className="section-spacing bg-gray-50">
        <div className="container mx-auto px-8">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="animate-fade-in">
              <img alt="Recovery Process" className="w-full aspect-[4/3] object-cover rounded-lg shadow-lg" src="/lovable-uploads/90f78098-0037-48fc-a65a-f2ffab41f597.jpg" />
            </div>
            <div className="content-spacing animate-fade-in">
      ...
      <section className="candidates-section-dark">
        <div className="container mx-auto px-8">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[{
              emoji: "📏",
              title: "Thin Tissue Coverage",
              description: "Requiring additional support"
            }, {
              emoji: "🔄",
              title: "Revision Surgery",
              description: "Correcting previous outcomes"
            }, {
              emoji: "⬇️",
              title: "Bottoming Out",
              description: "Preventing displacement"
            }, {
              emoji: "🌟",
              title: "Hybrid Techniques",
              description: "Fat + implant combinations"
