  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
        <img
          src="/placeholder.svg"
          alt="K-Glide Breast Augmentation Hero"
      ...
      <section className="section-spacing bg-white">
        <div className="container mx-auto px-8">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { step: "01", title: "Consultation", description: "Comprehensive assessment and goal setting" },
              { step: "02", title: "Anatomical Mapping", description: "Precise pocket planning" },
              { step: "03", title: "K-Glide™ Augmentation", description: "Motor-assisted dissection" },
              { step: "04", title: "Immediate Recovery", description: "No drains, minimal discomfort" },
              { step: "05", title: "Fast Return", description: "Back to daily activities in 24-48 hours" }
            ].map((item, index) => (
              <div 
                key={index} 
      ...
      <section className="candidates-section-dark">
        <div className="container mx-auto px-8">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { emoji: "✨", title: "Primary Augmentation", description: "First-time breast enhancement patients" },
              { emoji: "⚡", title: "Minimal Downtime", description: "Those who want quick recovery" },
              { emoji: "🛡️", title: "Tissue Preservation", description: "Prioritizing nerve & vessel safety" },
              { emoji: "🌸", title: "Natural Results", description: "Seeking soft, balanced contours" },
              { emoji: "⏱️", title: "Fast Recovery", description: "Back to routine in 24-48 hours" }
            ].map((candidate, index) => (
              <div 
                key={index} 
