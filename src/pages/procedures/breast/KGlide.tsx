...
const KGlide = () => {
  ...
  const overviewCards = [
    { number: "01", titleKey: "procedurePages.kglide.overview1Title", descKey: "procedurePages.kglide.overview1Desc" },
    { number: "02", titleKey: "procedurePages.kglide.overview2Title", descKey: "procedurePages.kglide.overview2Desc" },
    { number: "03", titleKey: "procedurePages.kglide.overview3Title", descKey: "procedurePages.kglide.overview3Desc" },
    { number: "04", titleKey: "procedurePages.kglide.overview4Title", descKey: "procedurePages.kglide.overview4Desc" },
    { number: "05", titleKey: "procedurePages.kglide.overview5Title", descKey: "procedurePages.kglide.overview5Desc" },
    { number: "06", titleKey: "procedurePages.kglide.overview6Title", descKey: "procedurePages.kglide.overview6Desc" },
  ];

  const journeySteps = [
    { step: "01", titleKey: "procedurePages.common.consultation", descKey: "procedurePages.kglide.journey1Desc" },
    { step: "02", titleKey: "procedurePages.common.anatomicalMapping", descKey: "procedurePages.kglide.journey2Desc" },
    { step: "03", titleKey: "procedurePages.kglide.journey3Title", descKey: "procedurePages.kglide.journey3Desc" },
    { step: "04", titleKey: "procedurePages.kglide.journey4Title", descKey: "procedurePages.kglide.journey4Desc" },
    { step: "05", titleKey: "procedurePages.kglide.journey5Title", descKey: "procedurePages.kglide.journey5Desc" },
  ];

  const candidates = [
    { emoji: "✨", titleKey: "procedurePages.kglide.candidate1Title", descKey: "procedurePages.kglide.candidate1Desc" },
    { emoji: "⚡", titleKey: "procedurePages.kglide.candidate2Title", descKey: "procedurePages.kglide.candidate2Desc" },
    { emoji: "🛡️", titleKey: "procedurePages.kglide.candidate3Title", descKey: "procedurePages.kglide.candidate3Desc" },
    { emoji: "🌸", titleKey: "procedurePages.kglide.candidate4Title", descKey: "procedurePages.kglide.candidate4Desc" },
    { emoji: "⏱️", titleKey: "procedurePages.kglide.candidate5Title", descKey: "procedurePages.kglide.candidate5Desc" },
  ];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
          <img alt={t("procedurePages.kglide.title")} className="absolute inset-0 w-full h-full object-cover animate-[scale-in_1.5s_ease-out]" src="/lovable-uploads/bdf1e8c7-0935-449c-b925-17d8716f8255.jpg" />
          ...
          <div className="container mx-auto px-8">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-12 lg:gap-16 relative">
              <div className="overview-sticky-left animate-fade-in">
                <div>
                  <h2 className="overview-title-dark">K-Glide™</h2>
        ...
        <section className="section-spacing bg-white">
          <div className="container mx-auto px-8 max-w-4xl text-center content-spacing">
            <p className="text-base md:text-lg text-gray-700 leading-relaxed animate-fade-in">
              {t("procedurePages.kglide.featured")}
            </p>
          </div>
        </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div className="order-2 lg:order-1 content-spacing animate-fade-in">
                  <h3 className="text-2xl md:text-3xl font-light tracking-wide uppercase mb-6">
                    {t("procedurePages.kglide.techTitle")}
                  </h3>
                  <ul className="space-y-4 text-base md:text-lg text-gray-700">
                    <li className="flex items-start gap-3">
                      <span className="text-gray-900 font-bold mt-1">•</span>
                      <span>{t("procedurePages.kglide.tech1")}</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-900 font-bold mt-1">•</span>
                      <span>{t("procedurePages.kglide.tech2")}</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-900 font-bold mt-1">•</span>
                      <span>{t("procedurePages.kglide.tech3")}</span>
                    </li>
                  </ul>
                </div>
                <div className="order-1 lg:order-2 animate-fade-in">
                  <img alt={t("procedurePages.kglide.techTitle")} className="w-full aspect-[4/3] object-cover rounded-lg shadow-lg" src="/lovable-uploads/34701841-4653-4973-acfd-4ec767fff02f.jpg" />
                </div>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div className="animate-fade-in">
                  <img alt={t("procedurePages.kglide.precisionTitle")} className="w-full aspect-[4/3] object-cover rounded-lg shadow-lg" src="/lovable-uploads/f2901edc-7f2d-4168-ad67-262a7f1de4a7.jpg" />
                </div>
                <div className="content-spacing animate-fade-in">
                  <h3 className="text-2xl md:text-3xl font-light tracking-wide uppercase mb-6">
                    {t("procedurePages.kglide.precisionTitle")}
                  </h3>
                  <ul className="space-y-4 text-base md:text-lg text-gray-700">
                    <li className="flex items-start gap-3">
                      <span className="text-gray-900 font-bold mt-1">•</span>
                      <span>{t("procedurePages.kglide.precision1")}</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-900 font-bold mt-1">•</span>
                      <span>{t("procedurePages.kglide.precision2")}</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="section-spacing bg-gray-50">
          <div className="container mx-auto px-8">
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="animate-fade-in">
                <img alt={t("procedurePages.common.recoveryHealing")} className="w-full aspect-[4/3] object-cover rounded-lg shadow-lg" src="/lovable-uploads/d3827c64-8e99-4121-9a26-be2826b51137.jpg" />
              </div>
              <div className="content-spacing animate-fade-in">
                ...
                <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-8">
                  {t("procedurePages.kglide.recovery")}
                </p>
