    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-[60vh] md:min-h-[70vh] flex items-center justify-start overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 lg:px-8 pt-24 md:pt-32">
            <div className="max-w-2xl space-y-6 float-in">
              <h1 
                className="text-4xl md:text-5xl lg:text-6xl font-light text-white leading-tight tracking-wide"
        ...
        <section className="py-16 lg:py-20 px-4 lg:px-8 bg-white">
          <div className="max-w-3xl mx-auto text-center float-in" style={{ animationDelay: '0.2s' }}>
            <h2 
              className="text-3xl md:text-4xl lg:text-5xl font-light mb-6 tracking-wide text-[#0d1f3a]"
              style={{ fontFamily: 'Cormorant Garamond, serif' }}
            >
        ...
        <section className="py-16 lg:py-24 px-4 lg:px-8 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            {/* Section Title */}
            <h2 
              className="text-4xl lg:text-5xl font-light text-center mb-16 lg:mb-20 tracking-wide text-[#0d1f3a] float-in"
              style={{ fontFamily: 'Cormorant Garamond, serif' }}
            >
            ...
            <div className="relative" ref={timelineRef}>
              ...
              <div className="space-y-16 lg:space-y-20">
                ...
                <div className="relative">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center float-in slide-in-left">
                    <div className="lg:order-1">
                      <div className="relative overflow-hidden rounded-lg shadow-lg" style={{ boxShadow: '0 0 30px rgba(30, 58, 95, 0.15)' }}>
                        <img src="/placeholder.svg" alt="Day 1 - Arrival" className="w-full h-auto object-contain" />
                      </div>
                    </div>
                    <div className="lg:order-2">
                      <div className="inline-block px-5 py-2.5 rounded-lg mb-4 text-xs uppercase tracking-widest font-semibold shadow-md" style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #4a6fa5 100%)', color: '#ffffff' }}>
                        {journeyDays[0].day}
                      </div>
                      <h3 className="text-2xl lg:text-3xl font-semibold mb-4 tracking-wide" style={{ fontFamily: 'Cormorant Garamond, serif', color: '#1e3a5f' }}>
                        {journeyDays[0].title}
                      </h3>
                ...
                <div className="relative">
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 hidden lg:flex items-center justify-center z-10">
                    <div className="w-6 h-6 rounded-full border-4 border-white shadow-lg animate-pulse" style={{ backgroundColor: '#1e3a5f', boxShadow: '0 0 0 4px rgba(30, 58, 95, 0.2), 0 0 20px rgba(30, 58, 95, 0.4)' }}></div>
                  </div>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center float-in slide-in-right" style={{ animationDelay: '0.15s' }}>
                    <div className="lg:order-2">
                      <div className="relative overflow-hidden rounded-lg shadow-lg" style={{ boxShadow: '0 0 30px rgba(30, 58, 95, 0.15)' }}>
                        <img src="/placeholder.svg" alt="Day 2 - Surgery" className="w-full h-auto object-contain" />
                      </div>
                    </div>
                    <div className="lg:order-1">
                      <div className="inline-block px-5 py-2.5 rounded-lg mb-4 text-xs uppercase tracking-widest font-semibold shadow-md" style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #4a6fa5 100%)', color: '#ffffff' }}>
                ...
                <div className="relative">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center float-in slide-in-left" style={{ animationDelay: '0.3s' }}>
                    <div className="lg:order-1">
                      <div className="relative overflow-hidden rounded-lg shadow-lg" style={{ boxShadow: '0 0 30px rgba(30, 58, 95, 0.15)' }}>
                        <img src="/placeholder.svg" alt="Day 3 - Recovery" className="w-full h-auto object-contain" />
                      </div>
                    </div>
                    <div className="lg:order-2">
                      <div className="inline-block px-5 py-2.5 rounded-lg mb-4 text-xs uppercase tracking-widest font-semibold shadow-md" style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #4a6fa5 100%)', color: '#ffffff' }}>
                ...
                <div className="relative">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center float-in slide-in-right" style={{ animationDelay: '0.45s' }}>
                    <div className="lg:order-2">
                      <div className="relative overflow-hidden rounded-lg shadow-lg" style={{ boxShadow: '0 0 30px rgba(30, 58, 95, 0.15)' }}>
                        <img src="/placeholder.svg" alt="Day 4 - Rest" className="w-full h-auto object-contain" />
                      </div>
                    </div>
                    <div className="lg:order-1">
                      <div className="inline-block px-5 py-2.5 rounded-lg mb-4 text-xs uppercase tracking-widest font-semibold shadow-md" style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #4a6fa5 100%)', color: '#ffffff' }}>
                ...
                <div className="relative">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center float-in slide-in-left" style={{ animationDelay: '0.6s' }}>
                    <div className="lg:order-1">
                      <div className="relative overflow-hidden rounded-lg shadow-lg" style={{ boxShadow: '0 0 30px rgba(30, 58, 95, 0.15)' }}>
                        <img src="/placeholder.svg" alt="Day 5 - Evaluation" className="w-full h-auto object-contain" />
                      </div>
                    </div>
                    <div className="lg:order-2">
                      <div className="inline-block px-5 py-2.5 rounded-lg mb-4 text-xs uppercase tracking-widest font-semibold shadow-md" style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #4a6fa5 100%)', color: '#ffffff' }}>
                ...
                <div className="relative">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center float-in slide-in-right" style={{ animationDelay: '0.75s' }}>
                    <div className="lg:order-2">
                      <div className="relative overflow-hidden rounded-lg shadow-lg" style={{ boxShadow: '0 0 30px rgba(30, 58, 95, 0.15)' }}>
                        <img src="/placeholder.svg" alt="Day 6 - Istanbul" className="w-full h-auto object-contain" />
                      </div>
                    </div>
                    <div className="lg:order-1">
                      <div className="inline-block px-5 py-2.5 rounded-lg mb-4 text-xs uppercase tracking-widest font-semibold shadow-md" style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #4a6fa5 100%)', color: '#ffffff' }}>
                ...
                <div className="relative">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center float-in slide-in-left" style={{ animationDelay: '0.9s' }}>
                    <div className="lg:order-1">
                      <div className="relative overflow-hidden rounded-lg shadow-lg" style={{ boxShadow: '0 0 30px rgba(30, 58, 95, 0.15)' }}>
                        <img src="/placeholder.svg" alt="Day 7 - Departure" className="w-full h-auto object-contain" />
                      </div>
                    </div>
                    <div className="lg:order-2">
                      <div className="inline-block px-5 py-2.5 rounded-lg mb-4 text-xs uppercase tracking-widest font-semibold shadow-md" style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #4a6fa5 100%)', color: '#ffffff' }}>
        ...
        <section className="py-16 lg:py-24 px-4 lg:px-8" style={{ background: 'linear-gradient(180deg, #f0f4f8 0%, #e8eef4 100%)' }}>
          <div className="max-w-6xl mx-auto">
            <h2 
              className="text-4xl lg:text-5xl font-light text-center mb-16 tracking-wide text-[#0d1f3a] float-in"
              style={{ fontFamily: 'Cormorant Garamond, serif' }}
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
              ...
              <div className="text-center animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-white shadow-lg flex items-center justify-center" style={{ boxShadow: '0 0 30px rgba(30, 58, 95, 0.15)' }}>
                  <img src="/placeholder.svg" alt="Medical Excellence Icon" className="w-10 h-10 object-contain" />
                </div>
                <h3 className="text-xl lg:text-2xl font-semibold mb-3 text-[#0d1f3a]" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
                  {whyChooseUs[0].title}
                </h3>
