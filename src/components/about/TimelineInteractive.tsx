  ...
  return (
    <section className="py-16 lg:py-20 px-8 lg:px-16 bg-white">
      <div className="max-w-7xl mx-auto">
        {/* Section Title */}
        <h2
          className="text-4xl lg:text-5xl font-light text-center mb-16 lg:mb-20 tracking-wide"
        ...
        <div className="relative" ref={timelineRef}>
          ...
          <div className="space-y-20 lg:space-y-24">
            {milestones.map((milestone, index) => {
              ...
              const date = t(`about.timeline.${milestone.milestoneKey}.date`);
              const title = t(`about.timeline.${milestone.milestoneKey}.title`);
              const description = t(`about.timeline.${milestone.milestoneKey}.description`);
              ...
              return (
                <div key={milestone.id} className="relative">
                  ...
                  <div
                    className={`grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center fade-in ${isEven ? 'slide-in-left' : 'slide-in-right'}`}
                  ...
                  >
                    ...
                    <div className={`${isEven ? 'lg:order-1' : 'lg:order-2'}`}>
                      {milestone.videoId ? (
                        ...
                        <img src={milestone.image} alt={title} className="" />
                      )}
                    </div>
