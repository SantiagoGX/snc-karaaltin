...
const HeroSection = () => {
  return <section className="relative min-h-[70vh] lg:min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 lg:px-8 pt-16 md:pt-20">
